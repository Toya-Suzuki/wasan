...
def main(argv):
    ...
    #Parameters
    # argv[1] Path to data folder, one single folder with all images
    # example image name: "PATH/14150Rep6782File17.png"
    ...
    #print("Model_"+str(argv[3]+" "+str(argv[6])))
    if training:
        print("Model_"+str(argv[3]+" "+str(argv[6])))
    ...
    if(predict):
        with open(predictFileName, "r") as f, open(argv[6], "a") as class_txt:
            f1=f.readlines()
            for line in f1:
                ...
                class_txt.write(imageToPredict+" "+str(pred_class)+"\n")
